  ...
  return [
    {
      ...
      content:
        ...
        "한국어 짧은 문장으로 요청한 컷 수만큼 설계한다. " +
        "등록된 핸들만 mention 가능하다. 예: @민수, @카페. " +
        "각 컷은 한 문장(20~80자)과 등장하는 @핸들을 포함해야 한다. " +
    ...
    },
    {
      ...
      content:
        ...
        `등록된 핸들:\n${handleList || "- 없음"}\n\n` +
        "출력 형식:\n" +
        `[{"prompt":"@민수가 @카페 문 앞에서 망설인다, 손에 쥔 종이를 만지작거린다","mentions":["민수","카페"]}]\n\n` +
        `반드시 ${sceneCount}개 배열 항목을 목표로 작성하고, prompt에는 위 등록 핸들만 사용한다.`
    }
  ];
}
