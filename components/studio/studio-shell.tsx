...
import {
  ...
  cloneLightingSelections,
  clonePoseSelections,
  combinePromptWithGuidance,
    ...
    <div className="flex h-full flex-1 flex-col">
      ...
      {previewRecord ? (
        <ImagePreviewModal
          ...
          zoomScale={previewZoom.scale}
          zoomTransform={previewZoom.transform}
          zoomBind={previewZoom.bind}
          isPanning={previewZoom.isPanning}
          onClose={closePreviewRecord}
          onZoomOut={previewZoom.zoomOut}
          onZoomReset={previewZoom.reset}
          onZoomIn={previewZoom.zoomIn}
          onRegenerate={handleRegeneratePreviewRecord}
          onCopyPrompt={handleCopyPreviewPrompt}
          onSetAsReference={handleSetPreviewAsReference}
          onRegisterAsCharacter={handleRegisterPreviewAsCharacter}
